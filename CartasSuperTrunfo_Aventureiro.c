...
int main() {
    ...
    float densidade_pop0, densidade_pop1; //armazena o cálculo da densidade populacional da cidade
    float pib_per_capita0, pib_per_capita1; //armazena o PIB per capita da cidade
    int valor; //designa o atributo a ser comparado das cartas
